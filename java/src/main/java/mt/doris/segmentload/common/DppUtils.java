...
public class DppUtils {
    ...
    public static Class getClassFromColumn(EtlJobConfig.EtlColumn column) throws SegmentLoadException {
        switch (column.columnType) {
            ...
            case "BIGINT":
                return Long.class;
            case "LARGEINT":
                throw new SegmentLoadException("LARGEINT is not supported now");
            case "FLOAT":
                return Float.class;
            case "DOUBLE":
                return Double.class;
    ...
    public static List<String> parseColumnsFromPath(String filePath, List<String> columnsFromPath) throws SegmentLoadException {
        ...
        if (strings.length < 2) {
            ...
            throw new SegmentLoadException("Reason: Fail to parse columnsFromPath, expected: " + columnsFromPath + ", filePath: " + filePath);
        }
